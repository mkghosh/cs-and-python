...
def largest_size(expect, numInsertions):
    '''
    lecture-in problems Q7. Find out the largest numInsertions.
    '''
    while numInsertions > 1:
        prob = collision_prob(365, numInsertions)
        if prob < expect:
